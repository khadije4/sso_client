...
// Only services with actual backend implementations
const AVAILABLE_SLUGS = ['sso-integration', 'face-recognition'];
    ...
    <div style={S.page}>
      ...
      <div>
        ...
        {svcsLoading ? (
          ...
          (services || []).filter(svc => AVAILABLE_SLUGS.includes(svc.slug)).map(svc => {
